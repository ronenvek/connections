...
function init(){
    ...
    names.set("david", ["ronen", "ron"])
    names.set("ronen", ["mirit", "ron", "gggggg"])
    names.set("mirit", ["david", "ronen"])
    names.set("a", ["ronen"])
    names.set("b", ["ronen"])
    names.set("c", ["ronen"])
    names.set("d", ["ronen"])
    names.set("gg", ["ronen"])
    names.set("ggg", ["ronen"])
    names.set("gggg", ["ronen"])
    names.set("ggggg", ["ronen"])
    names.set("gggggg", ["ronen", "g"])
    names.set("ron", ["ronen", "david"])
